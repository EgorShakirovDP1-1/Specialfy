    ...
    <Layout>
        ...
        <section class="p-4 bg-light">
            ...
            <form @submit.prevent="submitForm" class="mt-5">
                <h1 class="text-warning text-center mb-0">Rent a post</h1>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <input v-model="form.post_pickup_place" class="form-control" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <input v-model="form.post_return_place" class="form-control" type="text"
                                                placeholder="Enter custom starting point" />
                                        </li>
                                    </ul>
                                </div>
